...
var routes = function (_a) {
    ...
    app.post('/api/user', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        app.put('/api/user/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_controller_1.UserController.updateUserById(req.params.id)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.send(user)];
                }
        ...
        app.get('/api/user', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_controller_1.UserController.getAllUser()];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.send(user)];
                }
        ...
        app.get('/api/user/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_controller_1.UserController.findById(req.params.id)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.send(user)];
                }
        ...
        app.delete('/api/user/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_controller_1.UserController.removeUserById(req.params.id)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.send(user)];
                }
